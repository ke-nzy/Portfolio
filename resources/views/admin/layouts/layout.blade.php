...
<body>
  <div id="app">
    ...
    <div class="footer-left">
        Copyright &copy; 2023 <div class="bullet"></div> Created By <a href="https://nauval.in/">Kennedy Ngugi</a>
    </div>
  ...
  {{-- creates the textarea section with the editing tools --}}
  ...
  {{-- Sweet alert messsages in the project --}}
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    

  {{-- Show dynamiv validation errors --}}
  <script>
